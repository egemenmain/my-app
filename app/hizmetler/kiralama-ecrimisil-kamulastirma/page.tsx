...
export const metadata: Metadata = {
    ...
    description:
        "Emlak vergisi, çevre temizlik vergisi, ilan-reklam, kira ve diğer mali işlemler: borç sorgulama, online ödeme, taksit, indirim/muafiyet, son tarihler ve SSS.",
};
                ...
                <div className="grid gap-6 p-6 md:grid-cols-2 md:p-10">
                    <div className="flex flex-col justify-center">
                        ...
                        <p className="mt-3 text-gray-700">
                            Emlak Vergisi, Çevre Temizlik Vergisi (ÇTV), İlan-Reklam Vergisi ve belediye kira/harç ödemelerinin tamamı için
                    ...
                    <div className="relative">
                        {/* resim yerine sade blok: next/image domaintan kaçınmak için */}
            ...
            <div className="mt-10 grid grid-cols-1 gap-8 lg:grid-cols-[260px_1fr]">
                ...
                <main className="space-y-10">
                    <Section id="ozet" title="Özet">
                        <p>
                            Bu sayfa; <strong>Emlak Vergisi</strong>, <strong>Çevre Temizlik Vergisi (ÇTV)</strong>, <strong>İlan-Reklam Vergisi</strong>,
                            <strong> işgaliye/harç</strong> ve <strong>belediye kira</strong> ödemeleri hakkında {yil} yılı için güncel
                            işlemleri, kanalları ve son tarihleri içerir. Aşağıdaki adımlarla borcunuzu sorgulayabilir, online ödeyebilir,
                            taksit başvurusu yapabilir veya indirim/muafiyet haklarınızı kullanabilirsiniz.
                        </p>
                        <Callout title="Uyarı" tone="warning">
                            Resmî mevzuat değişebilir. Buradaki süreler ve ücretler bilgilendirme amaçlıdır;{" "}
                        ...
                        <div className="grid gap-4 md:grid-cols-2">
                            <div>
                                ...
                                <ul className="list-disc pl-5">
                                    ...
                                    <li>İşgaliye (pazar/sergi/işgaliye) tahakkuk ve ödeme</li>
                                </ul>
                            </div>
                            <div>
                                <h3 className="font-semibold">Kolaylıklar</h3>
                                <ul className="list-disc pl-5">
                                    <li><strong>Taksit Başvurusu</strong> (mevzuata bağlı borçlar)</li>
                                    <li><strong>Otomatik Ödeme Talimatı</strong> (banka/kredi kartı)</li>
                    ...
                    <Section id="odeme" title="Online Ödeme & Kanallar">
                        <div className="grid gap-4 md:grid-cols-2">
                            <div>
                                ...
                                <ul className="list-disc pl-5">
                                    <li><Link href="/ebelediye/odeme" className="text-blue-700 underline">Borç Sorgula & Öde</Link> (3D Secure, taksit seçenekleri bankanıza göre)</li>
                            ...
                            <table className="w-full text-left text-sm">
                                ...
                                <tbody className="divide-y">
                                    ...
                                    <tr>
                                        ...
                                        <td className="py-2 pr-4">1 Mart – 31 Mayıs {yil}</td>
                                        <td className="py-2 pr-4">1 Kasım – 30 Kasım {yil}</td>
                                        <td className="py-2">Konut iş yeri su tüketimine bağlı olabilir.</td>
                                    </tr>
                                    <tr>
                        ...
                        <div className="grid gap-4 md:grid-cols-2">
                            <div>
                                ...
                                <ul className="list-disc pl-5">
                                    ...
                                    <li>Engellilerde vergi indirimi/ÇTV muafiyeti (ikamet ve metrekare sınırları aranır)</li>
                            ...
                            <div>
                                ...
                                <ul className="list-disc pl-5">
                                    <li><Link href="/ebelediye/basvuru?service=vergi-indirim" className="text-blue-700 underline">e-Belediye Başvuru</Link> üzerinden formu doldurun</li>
                                    <li>Gerekli belgeleri yükleyin (aşağıdaki liste)</li>
                                    <li>Sonucu SMS/e-posta ile bildirilir</li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <Section id="kvkk" title="KVKK & Güvenlik">
                        <ul className="list-disc pl-5 space-y-1">
                            <li>Ödemeler 3D Secure altyapısıyla alınır; kart verisi belediyede tutulmaz.</li>
                            <li>Kişisel veriler yalnızca tahakkuk ve tahsilat amaçlarıyla işlenir.</li>
                            <li>Makbuzlar elektronik ortamda doğrulanabilir; taleple ıslak imzalı makbuz verilir.</li>
                        </ul>
                    </Section>
                    ...
                    <Section id="sss" title="Sık Sorulan Sorular">
                        ...
                        <details className="group py-3"><summary className="cursor-pointer list-none rounded-lg py-2 outline-none focus:ring-2 focus:ring-blue-400"><span className="font-medium">Taksitlendirme hangi borçlara uygulanır?</span></summary><div className="prose prose-sm max-w-none py-2 text-gray-700">Yürürlükteki mevzuat ve belediye meclis kararına göre belirlenir. Uygun borçlar için <Link href="/ebelediye/basvuru?service=taksit" className="text-blue-700 underline">taksit başvurusu</Link> yapabilirsiniz.</div></details>
                        <details className="group py-3"><summary className="cursor-pointer list-none rounded-lg py-2 outline-none focus:ring-2 focus:ring-blue-400"><span className="font-medium">İndirim/muafiyet onayı ne kadar sürer?</span></summary><div className="prose prose-sm max-w-none py-2 text-gray-700">Eksiksiz başvurularda hedef süre <strong>5–10 iş günü</strong>dür. Sonuç SMS/e-posta ile iletilir.</div></details>
                        <details className="group py-3"><summary className="cursor-pointer list-none rounded-lg py-2 outline-none focus:ring-2 focus:ring-blue-400"><span className="font-medium">Yanlış/çift ödeme iadesi mümkün mü?</span></summary><div className="prose prose-sm max-w-none py-2 text-gray-700">Dekontla birlikte dilekçe verildiğinde inceleme sonrası iade yapılır. Kart ödemelerinde iade bankanızın sürecine göre hesabınıza yansır.</div></details>
                        <details className="group py-3"><summary className="cursor-pointer list-none rounded-lg py-2 outline-none focus:ring-2 focus:ring-blue-400"><span className="font-medium">Mükellefiyet kapanışı nasıl yapılır?</span></summary><div className="prose prose-sm max-w-none py-2 text-gray-700"><Link href="/ebelediye/basvuru?service=mukellef-kapanis" className="text-blue-700 underline">Mükellefiyet Kapanış</Link> başvurusu yapıp tapu satış belgesi ve ilgili evrakları yüklerseniz işlem başlatılır.</div></details>
                    </Section>
